...
source history.bash       # make terminal better
# source network.bash      # shortcuts for network utilities
# source process.bash      # manage memory and CPU processes
source misc.bash         # misc
source nvm.bash          # load nvm
# source ruby.bash         # load rbenv
